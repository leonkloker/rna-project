...
# Model parameters
DIMENSIONS = [640, 512, 256, 128, 64, 1]
...
name = 'cnn_dim{}_epochs{}_lr{:.0E}_{}'.format(
            "_".join(str(i) for i in DIMENSIONS), NUM_EPOCHS, LEARNING_RATE, date)
...
# Initialize model
model = Conv1DModel(DIMENSIONS)
model = model.to(device)
model_info = summary(model, input_size=(BATCH_SIZE, 200, DIMENSIONS[0]))
